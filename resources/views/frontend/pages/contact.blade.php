...
@section('main-content')
	...
	<div class="map-section">
		<div id="myMap">
			<iframe src="https://www.google.com/maps?q=23.8103,90.4125&z=12&output=embed&hl=en" width="100%" height="100%" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0" title="Store location map"></iframe>
		</div>
	</div>
	<!--/ End Map Section -->
