...
@endsection
@section('title','DIU SHOP || PRODUCT DETAIL')
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="short">
                                                ...
                                                @endphp
												<p class="price"><span class="discount">{{ Helper::currency($after_discount) }}</span><s>{{ Helper::currency($product_detail->price) }}</s> </p>
                                ...
                                <div class="single-product">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="product-price">
                                            ...
                                            @endphp
                                            <span class="old">{{ Helper::currency($data->price) }}</span>
